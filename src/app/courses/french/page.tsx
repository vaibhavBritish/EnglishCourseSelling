...
const FrenchCourse = () => {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        const res = await fetch("/api/courses/french");
    ...
    <div className="text-black scroll-smooth mt-20" id="course">
      <div className="relative w-full h-64 md:h-[420px]">
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center text-white px-4">
          <h1 className="text-3xl md:text-5xl font-bold mb-3">French</h1>
          <p className="text-base md:text-lg max-w-2xl">
            Master French with interactive, structured, and practical
